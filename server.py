...
def epoch(gui_variables, days, lanes_ids):
    ...
    if shared_variables["mode"] != "test_static":
        html_summary += '<div class="row"><div class="col-md-6 font-weight-bold"><label>Phase Duration</label></div><div class="col"><label>' + str(shared_variables["phase_duration"]) + ' seconds</label></div></div>'
    html_summary += '\
    <div class="row"><div class="col-md-6 font-weight-bold"><label># Vehicles</label></div><div class="col"><p>' + str(shared_variables["num_vehicles"]) + '</p></div></div>\
    <div class="row"><div class="col-md-6 font-weight-bold"><label>Date</label></div><div class="col"><p>' + str(shared_variables["current_day"]) + '</p></div></div>\
    <div class="row"><div class="col-md-6 font-weight-bold"><label>Time</label></div><div class="col"><label>' + str(shared_variables["current_time"]) + '</label></div></div>\
    <div class="row"><div class="col-md-6 font-weight-bold"><label>Loss</label></div><div class="col"><label>' + str(shared_variables["loss"]) + '</label></div></div>\
    <div class="row"><div class="col-md-6 font-weight-bold"><label># Steps</label></div><div class="col"><label>' + str(shared_variables["current_step"]) + '</label></div></div>'
    ...
    for key in shared_variables:
        if "cumulative_queue_length_" in key:
            ...
            summary += "\nAverage queue length in " + key[24:] + ":\t\t" + str(shared_variables[key] / shared_variables["current_step"]) + " meters"
            html_summary += '<div class="row"><div class="col-md-6 font-weight-bold"><label>Avg. Queue Length in ' + key[24:] + '</label></div><div class="col"><label>' + str(shared_variables[key] / shared_variables["current_step"]) + ' meters</label></div></div>'
    ...
    for key in shared_variables:
        if "cumulative_time_delay_" in key:
            ...
            summary += "\nAverage time_delay in " +  key[22:] + ":\t\t" + str(shared_variables[key] / shared_variables["current_step"]) + " seconds"
            html_summary +=  '<div class="row"><div class="col-md-6 font-weight-bold"><label>Avg. Time Delay in ' + key[22:] + '</label></div><div class="col"><label>' + str(shared_variables[key] / shared_variables["current_step"]) + ' seconds</label></div></div>'
    ...
    html_summary += '<div class="row"><div class="col-md-6 font-weight-bold"><label>Avg. Queue Length in all Roads</label></div><div class="col"><label>' + str(shared_variables["avg_queue_length"]) + ' meters</label></div></div>'
    html_summary += '<div class="row"><div class="col-md-6 font-weight-bold"><label>Avg. Time Delay in all Roads</label></div><div class="col"><label>'+ str(shared_variables["avg_time_delay"]) + ' seconds</label></div></div>'
    html_summary += '<hr/>'
    print(summary)
